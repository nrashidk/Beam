...
export default function FTAAuditFiles() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await apiClient.post("/audit-files/generate", null, {
        params: {
              ...
              <CardContent className="space-y-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h4 className="font-medium text-blue-900 mb-2">
                    What is an FTA Audit File?
                  </h4>
                  <p className="text-sm text-blue-700">
                    The FTA Audit File (FAF) is a comprehensive export of your
                    company's invoice-level transactions required during UAE
                    Federal Tax Authority audits. It includes all sales and
                    purchase invoices with VAT details, customer/supplier
                    information, and compliance categorization.
                  </p>
                </div>
                ...
                {loadingFiles ? (
                  ...
                  <div className="text-center py-12 text-gray-500">
                    ...
                    <p className="text-sm mt-1">
                      Generate your first audit file above
                    </p>
                  </div>
                ) : (
                          ...
                          <div className="flex-1">
                            ...
                            {file.total_amount !== undefined && (
                              <div className="mt-2 text-sm text-gray-600">
                                ...
                                AED {file.total_amount.toFixed(2)} |{" "}
                                <span className="font-medium">VAT:</span> AED{" "}
                                {file.total_vat.toFixed(2)}
                              </div>
                            )}
            ...
            <Card className="bg-indigo-50 border-indigo-200">
              <CardContent className="pt-6">
                ...
                <div className="space-y-2 text-sm text-indigo-700">
                  <p>
                    <strong>•</strong> Audit files are generated on-demand and
                    contain invoice-level transaction detail
                  </p>
                  <p>
                    <strong>•</strong> Files include sales invoices, purchase
                    invoices, VAT amounts, and customer/supplier data
                  </p>
                  <p>
                    <strong>•</strong> CSV format is recommended for
                    compatibility with most accounting software
                  </p>
                  <p>
                    <strong>•</strong> All amounts are reported in the original
                    currency (AED for UAE transactions)
                  </p>
                  <p>
                    <strong>•</strong> Records are retained for 5 years as per
                    UAE FTA regulations
                  </p>
                </div>
              </CardContent>
