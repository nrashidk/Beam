  ...
  const submitBulkVerification = async () => {
    try {
      ...
      if (succeeded.length > 0) {
        setSuccessMessage(
          `Payment verified for ${succeeded.length} invoice(s)`,
        );
      }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex">
            ...
            <Card className="mb-4 bg-blue-50 border-blue-200">
              <CardContent className="pt-6">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  >
                    <CheckCircle size={16} />
                    Verify {selectedIds.length} Payment
      ...
      <Dialog open={showVerifyModal} onOpenChange={setShowVerifyModal}>
        <DialogContent className="max-w-lg w-[700px] overflow-x-hidden">
          <DialogHeader>
      ...
      <Dialog open={showBulkVerifyModal} onOpenChange={setShowBulkVerifyModal}>
        <DialogContent className="max-w-md w-[700px] overflow-x-hidden">
          <DialogHeader>
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="text-sm text-gray-700 mb-2">
                You are about to verify payments for{" "}
          ...
          <DialogFooter>
            <Button
              ...
              disabled={verifying || bulkLoading}
            >
              Cancel
            </Button>
            <Button
              onClick={submitBulkVerification}
              disabled={verifying || bulkLoading}
            >
              {verifying || bulkLoading
                ? "Verifying..."
                : `Confirm ${selectedIds.length} Payment${selectedIds.length > 1 ? "s" : ""}`}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
