...
export default function PEPPOLSettings() {
  ...
  const providers = [
    {
      ...
      description:
        "For development and testing - simulates PEPPOL transmission",
  ...
  const selectedProvider = providers.find(
    (p) => p.id === settings.peppol_provider,
  );
          ...
          <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-semibold text-blue-900">
                      About PEPPOL Integration
                    </h3>
                    <p className="text-sm text-blue-800">
                      PEPPOL (Pan-European Public Procurement On-Line) is the
                      international network for e-invoicing. In UAE, starting
                      July 2026, all B2B/B2G invoices must be transmitted via
                      accredited PEPPOL providers. InvoLinks integrates with
                      certified providers to send and receive invoices
                      automatically.
                    </p>
                    <p className="text-sm text-blue-800 font-medium">
                      Configure your provider below to enable automated invoice
                      transmission and FTA reporting.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enable or disable PEPPOL network integration
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          peppol_enabled: e.target.checked,
                        })
                      }
                    />
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Choose your accredited service provider
                </CardDescription>
              </CardHeader>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setSettings({
                            ...settings,
                            peppol_participant_id: e.target.value,
                          })
                        }
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                      />
                      <p className="text-sm text-gray-500 mt-1">
                        Format: 0190:&lt;Your 15-digit TRN&gt; (UAE scheme
                        identifier)
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setSettings({
                            ...settings,
                            peppol_base_url: e.target.value,
                          })
                        }
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                      />
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            placeholder={
                              settings.peppol_api_key?.startsWith("***")
                                ? "Currently configured (hidden)"
                                : "Enter your API key"
                            }
                  ...
                  <CardContent className="space-y-4">
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            {testResult.success &&
                              testResult.participant_valid !== undefined && (
                                <div className="text-sm text-green-700 mt-1">
                                  Participant ID:{" "}
                                  {testResult.participant_valid
                                    ? "Valid ✓"
                    ...
                    {settings.peppol_last_tested_at && !testResult && (
                      <div className="text-sm text-gray-500 text-center">
                        Last tested:{" "}
                        {new Date(
                          settings.peppol_last_tested_at,
                        ).toLocaleString()}
                      </div>
                    )}
                  </CardContent>
