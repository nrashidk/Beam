            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Secure invoice from {invoice.supplier_name}
                </p>
              </div>
            </div>
            <button
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                  ...
                  invoice.line_items.map((item) => (
                    <tr key={item.id} className="border-b border-gray-100">
                      ...
                      <td className="text-right py-4 font-medium text-gray-900">
                        ...
                        {item.line_extension_amount.toFixed(2)}
                      </td>
                    </tr>
                  ))}
              </tbody>
            ...
            <div className="mt-8 flex justify-end">
              <div className="w-full md:w-1/2 space-y-3">
                ...
                <div className="flex justify-between text-gray-700">
                  <span>VAT (5%)</span>
                  <span className="font-medium">
                    {invoice.currency_code} {invoice.tax_amount.toFixed(2)}
                  </span>
                </div>
          ...
          {(invoice.invoice_notes || invoice.notes) && (
            <div className="p-8">
              ...
              <div className="text-sm text-gray-700 whitespace-pre-line">{invoice.invoice_notes || invoice.notes}</div>
            </div>
          )}
          ...
          <div className="bg-gray-50 p-6 border-t border-gray-200">
            <div className="text-center text-sm text-gray-600">
              <p className="mb-2">
                This is a UAE-compliant tax invoice generated by InvoLinks
              </p>
              <p>
        ...
        <div className="mt-6 text-center space-y-3">
          ...
          <p className="text-sm text-gray-600">
            Invoice viewed{" "}
            {invoice.viewed_at
              ? "on " + new Date(invoice.viewed_at).toLocaleDateString("en-AE")
              : "for the first time"}
          </p>
        </div>
      </div>
