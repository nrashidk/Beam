...
export default function AdminMFASettings() {
  ...
  const handleDownloadBackupCodes = () => {
    ...
    a.href = url;
    a.download = "involinks-admin-backup-codes.txt";
    a.click();
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Manage your admin account security and authentication
                </p>
              </div>
            </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600">
                      Add an extra layer of security to your admin account by
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-red-800">
                              Your admin account will be less secure. Enter your
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-yellow-800">
                              This will invalidate your old backup codes. Enter
                              your verification code to confirm.
                            </p>
                          </div>
                        </div>
                            ...
                            <div className="bg-white p-4 rounded border border-yellow-300">
                              <div className="grid grid-cols-2 gap-3 font-mono text-sm">
                                {newBackupCodes.map((code, i) => (
                                  <div
                                    key={i}
                                    className="bg-gray-50 p-2 rounded text-center border border-gray-200"
                                  >
                                    {code}
                                  </div>
                                ))}
                    ...
                    <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
                      ...
                      <ul className="space-y-1 text-sm text-gray-700">
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            Protect your admin account even if your password is
                            compromised
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-blue-600">✓</span>
                          <span>
                            Critical security measure for administrative access
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-blue-600">✓</span>
                          <span>
                            Works with Google Authenticator, Microsoft
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Keep your backup codes in a secure location, like a
                          password manager
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          email OTP or backup codes
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-gray-400">•</span>
                        <span>
                          Consider setting up 2FA on your email account as well
