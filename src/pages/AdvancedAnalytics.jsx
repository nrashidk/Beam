...
const AdvancedAnalytics = () => {
  ...
  const fetchAnalyticsData = async () => {
    ...
    try {
      const [revenue, customers, profitability, cashFlow] = await Promise.all([
        apiClient.get("/analytics/revenue", { params: { months: timePeriod } }),
        apiClient.get("/analytics/customers", { params: { limit: 10 } }),
        apiClient.get("/analytics/profitability", {
          params: { months: timePeriod },
        }),
  ...
  const hasNoData =
    ...
    !profitabilityData?.total_revenue;
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="text-sm text-gray-600 mt-1">
                Avg: {formatCurrency(revenueData?.average_monthly_revenue || 0)}
                /mo
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="text-sm text-gray-600 mt-1">
                Avg Value:{" "}
                {formatCurrency(
                  customerData?.average_customer_lifetime_value || 0,
                )}
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              ...
              <div
                className={`text-sm mt-1 flex items-center gap-1 ${
                  (cashFlowData?.net_cash_position || 0) >= 0
                    ? "text-emerald-600"
                    : "text-red-600"
                }`}
              >
