...
export default function POFormModal({
  ...
  const removeLineItem = (index) => {
    ...
    setFormData((prev) => {
      ...
      return {
        ...prev,
        line_items: newLineItems.map((item, i) => ({
          ...item,
          line_number: i + 1,
        })),
      };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("supplier_contact_email", e.target.value)
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("supplier_peppol_id", e.target.value)
                  }
