...
export default function InwardInvoiceDetailModal({
  invoiceId,
  onClose,
  onUpdate,
}) {
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                {(() => {
                  ...
                  return (
                    <Badge
                      className={`${config.color} flex items-center gap-1 text-sm px-3 py-1`}
                    >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <p className="text-lg font-semibold text-gray-900">
                      ...
                      {invoice.subtotal_amount.toLocaleString()}
                    </p>
                  </div>
                  <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                    ...
                    {invoice.po_match_score !== undefined && (
                      <div>
                        ...
                        <p className="font-medium text-gray-900">
                          {invoice.po_match_score.toFixed(1)}%
                        </p>
                      </div>
                    )}
                    {invoice.amount_variance !== undefined &&
                      invoice.amount_variance !== 0 && (
                        <div>
                          <span className="text-gray-600">
                            Amount Variance:
                          </span>
                          <p
                            className={`font-medium ${invoice.amount_variance > 0 ? "text-red-600" : "text-green-600"}`}
                          >
                            {invoice.currency_code}{" "}
                            {invoice.amount_variance.toFixed(2)}
                          </p>
                        </div>
                      )}
                  </div>
