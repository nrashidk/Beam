...
- **Registration & Subscription:** Comprehensive registration collecting all mandatory company information (legal name, business type, phone, email, website, TRN, complete address details) in a single organized form with three sections (Company Information, Address Information, Security). All registration data automatically populated in company profile upon SuperAdmin approval, with business admins able to amend information via in-dashboard edit functionality. Includes email verification, token-based workflow, automatic Free tier assignment, and flexible free plan configuration. (Enhanced November 2025)
