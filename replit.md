...
- **Registration & Subscription:** Simplified signup collecting basic information (company name, phone, email, password). Additional company details (business type, website, address, TRN) can be added by business admin via in-dashboard edit functionality after approval. Includes email verification, token-based workflow, automatic Free tier assignment, and flexible free plan configuration.
